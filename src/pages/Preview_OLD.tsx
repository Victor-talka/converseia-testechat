...
const Preview = () => {
  ...
  const injetarWidget = useCallback(async () => {
    ...
    try {
      ...
      console.log("Injetando script do widget...");
      ...
      // Executa o script original sem modificações
      scriptElement.text = scriptContent;

      document.head.appendChild(scriptElement);
      console.log("Script injetado no DOM");
      
      // Remove popups após execução sem bloquear o widget
      setTimeout(() => {
        removerPopupsEBranding();
        reinjetandoRef.current = false;
        setIsLoading(false);
        
        // Verifica se widget foi criado
        ...
        if (widget) {
          ...
          console.log("Widget não encontrado, mas script foi injetado");
        }
      }, 2000);
